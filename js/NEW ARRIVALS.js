import { collection, query, where, getDocs, deleteDoc, doc, orderBy, limit } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";
...
async function displayNewArrivals() {
    ...
    try {
        ...
        const q = query(
            ...
            limit(12) // Show latest 12 products
        );
        const querySnapshot = await getDocs(q);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    displayProducts();
    console.log('Page loaded, fetching new arrivals...');
    displayNewArrivals();
});
