...
const sectionPosters = {
    'OUTFIT-SET': {
        ...
        description: 'Ready-to-wear coordinated outfits for couples.'
    },
    'TSHIRTS-TOPS': {
        image: 'image/replicate-prediction-6p2e4h9hfnrm80ckyhnb2dsqtr.png',
        title: 'T-Shirts & Tops',
        description: 'Matching casual wear for the perfect couple look.'
    },
    'SHIRTS-DRESSES': {
        image: 'image/replicate-prediction-6p2e4h9hfnrm80ckyhnb2dsqtr.png',
        title: 'Shirts & Dresses',
        description: 'Coordinated formal wear for special occasions.'
    },
    'JEANS-BOTTOMS': {
        image: 'image/replicate-prediction-6p2e4h9hfnrm80ckyhnb2dsqtr.png',
        title: 'Jeans & Bottoms',
        description: 'Stylish bottoms for a coordinated look.'
    },
    'HOODIES-SET': {
        image: 'image/replicate-prediction-6p2e4h9hfnrm80ckyhnb2dsqtr.png',
        title: 'Matching Hoodies',
        description: 'Cozy hoodies for couples to stay warm together.'
    }
};
...
function createSectionContainer(section) {
    return `
        <section class="products-section">
            ...
            <div class="products-grid" data-section="${section}">
                <!-- Products will be loaded here -->
            </div>
            <div class="explore-button-container">
                <a href="all-products.html?category=${section}&type=COUPLE" class="explore-all-btn">
                    Explore All ${sectionPosters[section]?.title || section}
                </a>
            </div>
        </section>
    `;
...
async function displayProducts() {
    ...
    try {
        ...
        const q = query(productsRef, where("category", "==", "COUPLE")); // Make sure this matches your database category
